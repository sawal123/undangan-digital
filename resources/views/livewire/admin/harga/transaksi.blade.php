    ...
    <tbody>
        @foreach ($transaksi as $index => $item)
            <tr>
                ...
                <td>
                    <button class="btn btn-primary btn-sm" wire:click='editTransaksi({{ $item->id }})'>Edit</button>
                    <button class="btn btn-danger btn-sm" wire:click='confirmDel({{ $item->id }})'>delete</button>
                </td>
            </tr>
        @endforeach
    </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" wire:click="updateTrans({{ $idTrans }})">Update
                        Transaksi</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-5">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        ...
                        <button class="btn btn-danger" wire:click='delTransaksi({{ $idTrans }})'>Hapus</button>
                    </div>
                </div>
