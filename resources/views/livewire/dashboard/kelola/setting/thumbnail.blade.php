 <div class="card-body d-flex flex-column flex-lg-row gap-3">
     ...
     <div class="d-flex flex-column">
         @if ($thumbnail)
             <img class="img-thumbnail rounded float-start object-fit-cover" style="height: 200px; width: auto"
                 ...
                 alt="Thumbnail">
             <button class="btn btn-sm btn-danger mt-2" wire:click="delThumbnail" wire:loading.attr="disabled" wire:target="delThumbnail">Hapus Gambar</button>
         @else
             <img class="img-thumbnail rounded float-start object-fit-cover" style="height: 200px; width: auto"
     ...
     <div class="text-lg-end">
         ...
         <form wire:submit.prevent='thumbnailWa'>
             ...
             <button class="btn btn-sm btn-primary mt-2" wire:loading.attr="disabled" wire:target="thumbnailWa">
                 <span wire:loading.remove wire:target="thumbnailWa">Upload Gambar</span>
                 <span wire:loading wire:target="thumbnailWa">Menyimpan...</span>
             </button>
         </form>
     </div>
 </div>
