<div class="space-y-6 max-w-3xl">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500 dark:text-slate-400">Bagikan link siaran langsung acara pernikahan Anda.</p>
                </div>
            </div>
            
            <div class="flex items-center gap-3 bg-slate-50 dark:bg-slate-900/50 p-4 rounded-2xl border border-slate-100 dark:border-slate-800">
                <span class="text-xs font-bold text-slate-500 uppercase tracking-wider">Aktifkan:</span>
                <label class="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" wire:click="updateFiturStreaming({{ $fiturStreaming ? 'false' : 'true' }})" class="sr-only peer" {{ $fiturStreaming ? 'checked' : '' }}>
    ...
    <div class="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm">
        <div class="space-y-6">
            <div>
                <label class="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">Link Streaming (YouTube, Zoom, dll.)</label>
                <div class="relative">
                ...
                <p class="mt-2 text-[10px] text-slate-400">Pastikan link dapat diakses secara publik atau oleh tamu yang memiliki link tersebut.</p>
            </div>
    ...
    <!-- Info Card -->
    <div class="bg-amber-50 dark:bg-amber-900/20 p-6 rounded-3xl border border-amber-100 dark:border-amber-800 flex gap-4">
        <div class="w-10 h-10 rounded-xl bg-amber-100 dark:bg-amber-800 flex items-center justify-center text-amber-600 dark:text-amber-400 flex-shrink-0">
            <i data-lucide="info" class="w-6 h-6"></i>
        </div>
        <div class="space-y-1">
            <h5 class="text-sm font-bold text-amber-800 dark:text-amber-300">Tips Streaming</h5>
            <p class="text-xs text-amber-700 dark:text-amber-400 leading-relaxed">
                Anda dapat menggunakan YouTube Live, Zoom, atau Google Meet. Jika menggunakan YouTube, pastikan Anda telah mengaktifkan fitur Live Streaming 24 jam sebelum hari-H.
            </p>
        </div>
    </div>
</div>
