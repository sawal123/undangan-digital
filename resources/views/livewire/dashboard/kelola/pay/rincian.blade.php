<div class="space-y-3">
    ...
    <div class="flex justify-between items-center pb-3 border-b border-slate-100 dark:border-slate-700">
        ...
        <span class="text-sm font-semibold text-slate-600 dark:text-slate-400">Rp
    ...
    @if ($promo > 0)
        <div class="flex justify-between items-center pb-3 border-b border-slate-100 dark:border-slate-700">
            ...
            <span class="text-sm font-semibold text-emerald-600 dark:text-emerald-400">- Rp
                {{ number_format($promo, 0, ',', '.') }}</span>
        </div>
    @endif
    ...
    <div class="flex justify-between items-center pt-1">
        ...
        <span class="text-base font-bold text-indigo-600 dark:text-indigo-400">Rp
            {{ number_format($total == 0 ? $harga : $total, 0, ',', '.') }}</span>
    </div>
</div>
