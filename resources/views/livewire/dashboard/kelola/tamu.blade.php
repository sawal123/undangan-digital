<div>
                ...
                <div class="card-body">
                    <div
                        ...
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#AddTamu"><i
                                class="mdi mdi-plus"></i> Tambah Tamu</button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                ...
                                                <button class="btn btn-sm btn-light border-info" wire:click="shareWA({{ $item->id }})">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-dark">
                                                        <li><a class="dropdown-item" href="{{url('/').'/'.$item->data->slug.'/'.$item->kode}}">Lihat Undangan</a>
                                                        </li>
                                                        <li><button class="dropdown-item" data-bs-toggle="modal" wire:click='EditTamu({{ $item->id }})'>Edit</button></li>
                                                        <li><button class="dropdown-item" wire:click="delete({{$item->kode}})">Hapus</button></li>
                                                    </ul>
                                                </div>
                                            </div>
    ...
    <x-modal-slot id="shareTamu" title="Share Link" other="wire:defer">
        <div class="p-3">
            ...
            <input wire:model="slug" type="url" class="form-control form-control-solid form-control-sm ">
            <button class="btn btn-danger btn-sm w-100 mt-2">Copy Link</button>
        </div>
    </x-modal-slot>
</div>
