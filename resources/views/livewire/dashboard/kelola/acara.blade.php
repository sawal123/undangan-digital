<div>
                ...
                <div class="card  hover-shadow border border-info">
                    <div class="card-body flex-column d-flex">
                        ...
                        <small class="text-danger">
                            ...
                            {{ $item->jam_start }} {{ $zonaWaktuStart }} s/d
                            {{ $item->jam_end }} {{ $zonaWaktuEnd }}
                        </small>
                        ...
                        <div class="d-flex gap-2">
                            <button data-bs-toggle="modal" onclick="@this.call('confirmDelete', {{ $item->id }})"
                                class="btn btn-sm btn-danger">
                                <i class="mdi mdi-trash-can"></i> Hapus
                            </button>

                            <button wire:click="edit({{ $item->id }})" data-bs-toggle="modal" {{-- data-bs-target="#EditAcara"  --}}
    ...
    <x-modal-confirm id="hapusAcara" deskripsi="Apakah Anda yakin ingin menghapus acara ini?" wire="delete"
