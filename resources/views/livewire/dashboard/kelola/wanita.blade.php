    ...
    <form wire:submit.prevent="save" wire:ignore.self class="space-y-5">
        ...
        <div class="flex flex-col sm:flex-row gap-4">
            ...
            <div class="flex-1">
                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Gambar <span
                        class="text-rose-500">*</span></label>
                <input id="gambar_wanita" name="gambar" wire:model="newImage" type="file"
        ...
        <div class="pt-4 mt-6 border-t border-slate-200 dark:border-slate-800">
            <button type="submit" wire:loading.attr="disabled" wire:target="save"
                class="inline-flex items-center justify-center px-4 py-2 bg-pink-600 hover:bg-pink-700 text-white text-sm font-medium rounded-xl transition-colors gap-2 w-full sm:w-auto disabled:opacity-60 disabled:cursor-not-allowed">
                ...
                <span wire:loading.remove wire:target="save">Simpan Data Wanita</span>
