<div>
    ...
    <form wire:submit.prevent="save" wire:ignore.self class="space-y-5">
        ...
        <div class="pt-4 mt-6 border-t border-slate-200 dark:border-slate-800">
            <button type="submit" class="inline-flex items-center justify-center px-4 py-2 bg-pink-600 hover:bg-pink-700 text-white text-sm font-medium rounded-xl transition-colors gap-2 w-full sm:w-auto">
                <i data-lucide="check-circle" class="w-4 h-4"></i> Simpan Data Wanita
            </button>
        </div>
    </form>
</div>
