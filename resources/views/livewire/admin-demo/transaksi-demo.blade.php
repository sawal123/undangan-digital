                ...
                <td class="px-5 py-3.5">
                    @php
                        $statusClasses = [
                            ...
                            'EXPIRE' => 'bg-slate-50 text-slate-700 border-slate-200 dark:bg-slate-800 dark:text-slate-400 dark:border-slate-700',
                        ];
                        $class = $statusClasses[$t->payment_status] ?? $statusClasses['EXPIRE'];
                    @endphp
        ...
        <form wire:submit="update" class="space-y-4">
            ...
            <div class="p-4 bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-700 rounded-xl">
                <p class="text-xs text-indigo-700 dark:text-indigo-400 flex gap-2">
                    ...
                    <span>Status <b>SUCCESS</b> atau <b>SETTLEMENT</b> akan otomatis mengaktifkan undangan terkait.</span>
                </p>
            </div>
