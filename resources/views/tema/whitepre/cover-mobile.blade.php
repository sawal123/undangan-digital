...
<div id="cover-mobile" class="h-full w-full  fixed lg:hidden block z-50 text-white"
    ...
    <div class="w-full text-shadow flex justify-center items-center flex-col">
        ...
        <button id="open-cover" style="background: #FFFFFFFF !important; color: black !important;"
            class=" px-4 py-2 font-semibold rounded-full  border-dark border-2 animate-bounce">
            Buka Undangan
        </button>
    </div>
</div>
