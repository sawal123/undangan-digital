   ...
   <div class="live-stream pb-5" data-aos="fade-up" data-aos-duration="1000">
       ...
       <a href="{{ $data->streaming?->link ?? '#' }}" class="live-stream-button" data-aos="fade-up"
           data-aos-duration="1000"><i class="fa-solid fa-play mr-2" data-aos="fade-up" data-aos-duration="1000"></i>
           Tonton Live
           Streaming</a>
   </div>
