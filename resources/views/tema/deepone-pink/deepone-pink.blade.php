...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-gold:active { transform: scale(0.96); background: #db8aac; }
        ...
        .timeline-content strong { font-size: 1.1rem; display: block; color: #b46384; }
        ...
        .wish-card { background: #fff7fa; border: 1px solid #fad5e5; border-radius: 28px; padding: 16px; margin-bottom: 16px; }
        .wish-alert {
            border-radius: 22px;
            padding: 12px 14px;
            margin-bottom: 14px;
        ...
        .nav-item { text-align: center; color: #b15e82; font-size: 0.7rem; transition: 0.2s; cursor: pointer; }
...
<body>
    <div class="phone-container">
        ...
        <div class="main-content" id="mainContent">
                        ...
                        <div id="wishesList" style="margin-top: 32px;">
                            @forelse ($ucapan as $item)
                                <div class="wish-card">
                                    ...
                                    <span style="background:#fad5e5; border-radius:20px; padding:2px 10px; font-size:12px;">{{ $item->status }}</span>
                                    <p>{{ $item->ucapan }}</p>
            ...
            <section id="closingSection" style="background: linear-gradient(rgba(80,40,55,0.7), rgba(60,30,40,0.8)), url('{{ $heroImage }}'); background-size: cover; background-position: center; color:white; text-align:center; border-bottom: none;">
                <div class="floral-divider"><span>*</span><span>+</span><span>*</span></div>
