...
<div class="mt-5 w-full py-16 flex flex-col relative mx-0 px-4 bg-zinc-800 shadow-inner shadow-black">
    ...
    <div class="text-center w-full mb-10 font-italiana z-10" data-aos="fade-up" data-aos-duration="3000">
        ...
        <p class="text-xs uppercase tracking-widest text-amber-400 font-bold block pb-2" style="color: #fbbf24 !important;">Momen indah kita berdua</p>
    ...
    <div class="w-full flex flex-col gap-10 z-10 mb-12 mt-4">
        @foreach ($data->kisah as $item)
            <div class="w-full bg-stone-900 rounded-3xl overflow-hidden shadow-2xl border border-stone-700 flex flex-col" data-aos="fade-up" data-aos-duration="2000">
                <!-- Bagian Gambar Atas -->
                ...
                <div class="w-full p-6 flex flex-col justify-start text-white bg-stone-900">
                    <h3 class="text-base font-bold mb-3 text-amber-300 tracking-wide text-start" style="color: #fcd34d !important;">{{ $item->title }}</h3>
