    ...
    <div class="phone-container">
        ...
        <div class="main-content" id="mainContent">
                        ...
                        <div id="wishesList" style="margin-top: 32px;">
                            @forelse ($ucapan as $item)
                                <div class="wish-card">
                                    ...
                                    <span
                                        style="background:#f0e0ce; border-radius:20px; padding:2px 10px; font-size:12px;">{{ $item->status }}</span>
                                    <p>{{ $item->ucapan }}</p>
            ...
            <section id="closingSection"
                style="background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('{{ $heroImage }}'); background-size: cover; background-position: center; color:white; text-align:center; border-bottom: none;">
                <div class="floral-divider"><span>*</span><span>+</span><span>*</span></div>
