    ...
    <div class="container">
        ...
        <ul class="buy-button list-inline mb-0">
            ...
            <li class="list-inline-item ps-1 mb-0">
                <a href="https://1.envato.market/landrick" target="_blank" class="btn btn-icon btn-pills btn-primary"><i class="uil uil-wallet"></i></a>
            </li>
        </ul><!--end login button-->
            ...
            <ul class="navigation-menu">
                ...
                <li class="has-submenu parent-menu-item">
                    ...
                    <ul class="submenu">                                        
                        ...
                        <li><a href="auth-signup-bg-video.html" class="sub-menu-item">Signup</a></li>
                        <li><a href="auth-reset-password-bg-video.html" class="sub-menu-item">Reset Password</a></li>
                ...
                <li><a href="page-contact-one.html" class="sub-menu-item"> Contact</a></li>
