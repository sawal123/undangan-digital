                ...
                <div class="col-12">
                    <div class="card form-signin p-4 rounded shadow">
                        <form action="{{ route('register.store') }}" method="POST">
                            @csrf
                            <a href="index.html"><img src="{{ asset('logo/logo.svg') }}"
                            ...
                            @if (config('security.turnstile.enabled') && config('security.turnstile.site_key'))
                                <div class="cf-turnstile mb-3" data-sitekey="{{ config('security.turnstile.site_key') }}">
                                </div>
                                @error('captcha')
                            ...
                            <div class="col-12 text-center mt-3">
                                <p class="mb-0 mt-3"><small class="text-dark me-2">Sudah Punya Akun ?</small> <a
                                        href="{{ route('login') }}" wire:navigate class="text-dark fw-bold">Sign in</a></p>
                            </div><!--end col-->
