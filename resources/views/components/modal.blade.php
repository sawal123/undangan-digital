@props(['id', 'title', 'wire', 'textButton', 'other'=>null])

<div class="modal fade" id="{{$id}}" data-bs-backdrop="static" {{$other}} tabindex="-1" aria-labelledby="{{$id}}-title" aria-hidden="true">
