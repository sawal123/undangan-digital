    ...
    <div class="header-bar d-flex justify-content-between">
        <div class="d-flex align-items-center">
            <a href="#" class="logo-icon me-3">
                <img src="{{ asset('assetDashboard/images/logo-icon.png') }}" height="30" class="small" alt="">
                <span class="big">
                    ...
                    <div class="dropdown-menu dd-menu shadow rounded border-0 mt-3 p-0" data-simplebar
                        ...
                        <div class="p-3">
                            ...
                            <a href="#!" class="dropdown-item features feature-primary key-feature p-0 mt-3">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assetDashboard/images/client/04.jpg') }}"
                            ...
                            <a href="#!" class="dropdown-item features feature-primary key-feature p-0 mt-3">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assetDashboard/images/client/15.jpg') }}"
                                        class="avatar avatar-md-sm rounded-circle border shadow me-2" alt="">
                                    <div class="flex-1">
                ...
                <div class="dropdown dropdown-primary">
                    ...
                    <div class="dropdown-menu dd-menu dropdown-menu-end shadow border-0 mt-3 py-3"
                        ...
                        <a class="dropdown-item d-flex align-items-center text-dark pb-3" href="profile.html">
                            <img src="{{ asset('assetDashboard/images/client/05.jpg') }}"
