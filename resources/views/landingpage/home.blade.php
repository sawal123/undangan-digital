<div class="min-h-screen scroll-smooth bg-[#fffaf7] font-sans text-slate-800">
    <header class="sticky top-0 z-30 border-b border-amber-100 bg-white/90 shadow-sm backdrop-blur-md">
        <div class="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 md:px-8">
            ...
            <button type="button" class="text-2xl text-slate-600 md:hidden" id="landingMenuButton" aria-label="Buka menu">
                <i class="fas fa-bars"></i>
            </button>
        </div>

        <div id="landingMobileMenu" class="hidden border-t border-amber-100 bg-white px-5 py-3 text-slate-700 md:hidden">
            <div class="flex flex-col gap-2">
                <a href="#layanan" class="py-2 transition hover:text-amber-600"><i class="fas fa-envelope-open-text w-6"></i> Layanan</a>
                <a href="#fitur" class="py-2 transition hover:text-amber-600"><i class="fas fa-star w-6"></i> Fitur</a>
                <a href="#promo" class="py-2 transition hover:text-amber-600"><i class="fas fa-tag w-6"></i> Penawaran</a>
    ...
    <main>
        <section class="relative overflow-hidden bg-gradient-to-br from-[#fff5f0] to-[#ffe9e0]">
            <div class="pointer-events-none absolute -left-20 -top-20 h-72 w-72 rounded-full bg-amber-200/30 blur-3xl"></div>
            <div class="pointer-events-none absolute bottom-10 right-0 h-80 w-80 rounded-full bg-rose-200/30 blur-3xl"></div>
            ...
            <div class="relative z-10 mx-auto max-w-7xl px-5 py-16 md:px-8 md:py-24">
                <div class="flex flex-col items-center gap-12 lg:flex-row">
                    <div class="flex-1 text-left   sm:text-center ">
                        <div class="mb-5 inline-flex items-center rounded-full border border-white/50 bg-white/70 px-4 py-1.5 text-sm font-medium text-amber-700 shadow-sm backdrop-blur-sm">
                        ...
                        <div class="mt-10 flex flex-wrap justify-center gap-6 text-sm font-medium text-slate-600 md:justify-start">
                            <div class="flex items-center gap-2"><i class="fas fa-check-circle text-amber-500"></i> Hemat Budget</div>
                            <div class="flex items-center gap-2"><i class="fas fa-check-circle text-amber-500"></i> Praktis & Cepat</div>
                            <div class="flex items-center gap-2"><i class="fas fa-check-circle text-amber-500"></i> Simple Modern</div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-1 justify-center">
                        <div class="relative w-72 md:w-96">
                            ...
                            <div class="absolute -bottom-5 -right-5 flex items-center gap-2 rounded-xl bg-white p-3 shadow-xl">
        ...
        <section id="layanan" class="bg-white py-20">
            <div class="mx-auto max-w-7xl px-5 md:px-8">
                <div class="mx-auto mb-14 max-w-3xl text-center">
                    <h2 class="font-display text-3xl font-bold text-slate-800 md:text-4xl">Jasa Lengkap untuk Hari Bahagia</h2>
                    <div class="mx-auto mt-4 h-1 w-24 rounded-full bg-amber-400"></div>
                    <p class="mt-4 text-slate-500">Pilih sesuai gaya dan kebutuhan Anda: online, cetak, atau animasi eksklusif.</p>
                </div>

                <div class="grid gap-8 md:grid-cols-3">
                    <article class="flex h-full flex-col rounded-2xl border border-amber-100 bg-white p-6 text-center shadow-lg transition hover:-translate-y-1.5 hover:shadow-xl">
                        ...
                        <p class="mt-2 text-sm text-slate-500">Digital interaktif, akses selamanya. Bagikan link ke seluruh tamu tanpa batas.</p>
                    ...
                    <article class="flex h-full flex-col rounded-2xl border border-rose-100 bg-white p-6 text-center shadow-lg transition hover:-translate-y-1.5 hover:shadow-xl">
                        ...
                        <p class="mt-2 text-sm text-slate-500">Premium paper, desain eksklusif, pilihan sampul dan finishing elegan.</p>
                        <ul class="mt-4 space-y-1 text-left text-sm text-slate-600">
                    ...
                    <article class="flex h-full flex-col rounded-2xl border border-indigo-100 bg-white p-6 text-center shadow-lg transition hover:-translate-y-1.5 hover:shadow-xl">
                        ...
                        <p class="mt-2 text-sm text-slate-500">Motion graphic personal, storytelling cinta yang terasa hidup dan berkesan.</p>
                        <ul class="mt-4 space-y-1 text-left text-sm text-slate-600">
        ...
        <section id="fitur" class="bg-[#fefaf8] py-20">
            <div class="mx-auto max-w-7xl px-5 md:px-8">
                <div class="mb-14 text-center">
                    <div class="inline-flex items-center gap-2 rounded-full border border-amber-200 bg-white/80 px-4 py-1.5 text-sm font-semibold text-amber-700 shadow-sm">
                        <i class="fas fa-gem text-amber-500"></i> Keunggulan Premium
                    </div>
                    <h2 class="mt-4 font-display text-3xl font-bold text-slate-800 md:text-5xl">Fitur Apa Saja Yang Kamu Dapat?</h2>
                    <p class="mx-auto mt-3 max-w-2xl text-lg text-slate-500">Dengan fitur lengkap, kamu bisa atur sendiri.</p>
                </div>

                <div class="grid gap-7 sm:grid-cols-2 lg:grid-cols-3">
                    @foreach ([
                        ['icon' => 'fa-infinity', 'title' => 'Aktif Selamanya', 'text' => 'Undangan web dan animasi tidak kedaluwarsa, akses seumur hidup.', 'color' => 'text-amber-600'],
                        ['icon' => 'fa-music', 'title' => 'Bebas Music', 'text' => 'Pilih lagu favorit, atur playlist sendiri tanpa ribet.', 'color' => 'text-amber-600'],
                        ['icon' => 'fa-hands-praying', 'title' => 'Ucapan & Doa', 'text' => 'Tamu bisa kirim doa dan ucapan langsung di undangan.', 'color' => 'text-amber-600'],
                        ['icon' => 'fa-gift', 'title' => 'Kado', 'text' => 'Fitur kado online, transfer via bank dan e-wallet terintegrasi.', 'color' => 'text-amber-600'],
                        ['icon' => 'fa-whatsapp', 'title' => 'Kirim WA', 'text' => 'Kirim undangan langsung ke WhatsApp tamu, praktis dan cepat.', 'color' => 'text-green-600', 'brand' => true],
                        ['icon' => 'fa-images', 'title' => 'Galeri Foto & Video', 'text' => 'Unggah momen prewedding, video undangan, dan cerita cinta.', 'color' => 'text-amber-600'],
                    ] as $feature)
                        <article class="flex items-start gap-4 rounded-xl bg-white p-6 shadow-md transition hover:-translate-y-1 hover:shadow-lg">
                            <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[#fdf0e9]">
                                <i class="{{ $feature['brand'] ?? false ? 'fab' : 'fas' }} {{ $feature['icon'] }} text-2xl {{ $feature['color'] }}"></i>
                            </div>
                            <div>
                ...
                <div class="mx-auto max-w-4xl overflow-hidden rounded-3xl border border-amber-100 bg-white shadow-2xl">
                    <div class="grid md:grid-cols-2">
                        <div class="p-8 md:p-10">
                            <div class="mb-4 inline-flex items-center gap-2 rounded-full bg-amber-100 px-4 py-1.5 text-sm font-semibold text-amber-800">
                                <i class="fas fa-bolt"></i> Special Offer
                            </div>
                            <h2 class="font-display text-3xl font-bold leading-tight text-slate-800 md:text-4xl">Jangan Ragu Untuk Hari Istimewa</h2>
                            <div class="my-4 rounded-xl border-l-8 border-amber-400 bg-amber-50 p-4">
                                <p class="flex flex-wrap items-center gap-2 text-xl font-bold text-slate-800 md:text-2xl">
                                    <i class="fas fa-credit-card text-amber-600"></i> Bayar Sekali
                                    <span class="text-amber-600">Bisa Digunakan Berkali-kali</span>
                                </p>
                                <p class="mt-1 text-slate-600">Tidak ada biaya bulanan, cukup investasi sekali untuk undangan dan revisi.</p>
                            </div>
                            <ul class="mb-6 space-y-2 text-slate-700">
                                <li><i class="fas fa-check-circle mr-2 text-amber-500"></i> Update konten kapan saja</li>
                                <li><i class="fas fa-check-circle mr-2 text-amber-500"></i> Bisa cetak ulang kapan pun</li>
    ...
    <footer class="mt-6 bg-slate-900 py-10 text-slate-300">
        <div class="mx-auto max-w-7xl px-5 md:px-8">
            ...
            <div class="mt-6 text-center text-xs text-slate-500">Bayar sekali, tenang selamanya. Dari hati untuk hari spesialmu.</div>
        </div>
    </footer>
</div>
